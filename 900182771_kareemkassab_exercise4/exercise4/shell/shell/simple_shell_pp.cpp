...
# 6 "simple_shell.cpp" 2


# 7 "simple_shell.cpp"
int getArgumentsCount (char * command)
{
 int arg_count = 0;
...
void setArguments (char * command,char ** arguments)
{
 int arg_index = 0;
...
# 39 "simple_shell.cpp"
 ...
 arg[arg_count] = 
# 48 "simple_shell.cpp" 3 4
                 __null
# 48 "simple_shell.cpp"
                     ;
 setArguments (command,arg);
